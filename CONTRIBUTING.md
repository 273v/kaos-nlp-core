...
`kaos-nlp-core` requires Python 3.13 or newer. It publishes the `kaos_nlp_core`
import package. This package publishes CLI entry point(s): `kaos-nlp`, `kaos-nlp-serve`.
...
include the `kaos-nlp-core` version, Python version, operating system,
