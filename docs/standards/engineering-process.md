...
This document defines how `kaos-nlp-core` handles features, bugs,
...
- What `kaos-nlp-core` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_nlp_core`.
